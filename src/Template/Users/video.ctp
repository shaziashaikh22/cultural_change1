        ...
        <div class="row">
            ...
            <div class="col-sm-10">
                ...
                <video width="80%" height="70%" controls id="myvideo">
                    <source type="video/mp4" src="<?php echo $this->request->webroot; ?>img/EBB BrainHouse Video Introduction.mp4">
                </video>
                </div>
                ...
                echo $this->Html->link(
                    'Next',
                    ['controller' => 'Users', 'action' => 'jobdescround1'],['style'=>'color:white;font-weight:bold;font-size:20px;']
                );
                ?>
            <div class="bottom">

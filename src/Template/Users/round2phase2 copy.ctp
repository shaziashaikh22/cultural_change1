...
<!-- architect score, limit, shape name  -->
  ...
  <!-- 1 bath with bathtub -->
  <input type="hidden" name="bath_with_bathtub1" id="bath_with_bathtub1" value="" /><!-- value = "bath with bathtub" -->
  

<!-- carpenter score, limit, shape name -->
<!-- 1 Big Window -->
<input type="hidden" name="bigwindow_1" id="bigwindow_1" value="" /><!-- value = "Big window" -->

<!-- 2 double door/single door -->
<input type="hidden" name="door_1" id="door_1" value="" /><!-- value = "double door/door" -->
<input type="hidden" name="door_2" id="door_2" value="" /><!-- value = "double door/door" -->
...
<!-- 1 dining table -->
<input type="hidden" name="dining_table_1" id="dining_table_1" value="" /><!-- value = "Big dining" -->
...
<!-- 1 lamp -->
<input type="hidden" name="lamp_1" id="lamp_1" value="" /><!-- value = "lamp" -->
...
// for architect score work start 7-12-2022
        ...
        if(shapename != "Large Bed Room" && shapename != "Large Living Room" && shapename != "Office" && shapename != "Kitchen" && shapename != "bath with bathtub"){
      ...
      // for architect score work end 7-12-22
       ...
       if (current_user_role == 2) {
        ...
        if(shapename != "Big window" && shapename != "double door" && shapename != "door" && shapename != "sliding doors"){
          var new_input = `<input type='hidden' class='undo_redo_score' value='0' id='undo_'>`;
        $('#hidden_input_score_div').append(new_input);
        }

        if (shapename == "Big window") { //if shape is Big window [limit 1]
        ...
        if (shapename == "double door" || shapename == "door") { // if shape name is double door/door
 ...
 if (current_user_role == 1) {
  if(shapename != "tree1" && shapename != "tree2" && shapename != "tree3" && shapename != "plant1" && shapename != "plant2" && shapename != "plant3" && shapename != "bush1" && shapename != "bush2" && shapename != "bush3" && shapename != "Family swing" && shapename != "fountain" && shapename != "slide"){
          var new_input = `<input type='hidden' class='undo_redo_score' value='0' id='undo_'>`;
        $('#hidden_input_score_div').append(new_input);
        }
...
// Interior Designer score work start 7-12-2022
    if (current_user_role == 4) { // if user role is Interior Designer
      ...
      if(shapename != "sofa1" && shapename != "sofa2" && shapename != "carpet" && shapename != "Big dining" && shapename != "study" && shapename != "table" && shapename != "lamp" ){
          var new_input = `<input type='hidden' class='undo_redo_score' value='0' id='undo_'>`;
        $('#hidden_input_score_div').append(new_input);
        }
      ...
      if (shapename == "sofa1" || shapename == "sofa2") { // if shape name is sofa1/sofa2
        ...
        if (shapename == "lamp") { // if shape name is lamp

...
<body>
  ...
  <input type="hidden" name="bath_with_shower1" id="bath_with_shower_1" value="" /><!-- value = "Bathroom with shower" -->
  
  <!-- 1 Bathroom with bathtub -->
  <input type="hidden" name="bath_with_bathtub" id="bath_with_bathtub" value="" /><!-- value = "Bathroom with bathtub" -->
  <!-- 1 Open kitchen and living room -->
  <input type="hidden" name="living_with_kitchen" id="living_with_kitchen" value="" /><!-- value = "Open kitchen and living room" -->

  <!-- carpenter score, limit, shape name -->
  <!-- 5 Window -->
  <input type="hidden" name="big_window1" id="big_window1" value="" /><!-- value = "Window" -->
  <input type="hidden" name="big_window2" id="big_window2" value="" /><!-- value = "Window" -->
  <input type="hidden" name="big_window3" id="big_window3" value="" /><!-- value = "Window" -->
  <input type="hidden" name="big_window4" id="big_window4" value="" /><!-- value = "Window" -->
  <input type="hidden" name="big_window5" id="big_window5" value="" /><!-- value = "Window" -->
  ...
  <!-- 2 swings -->
  <input type="hidden" name="swing_1" id="swing_1" value="" /><!-- value = "swing" -->
  <input type="hidden" name="swing_2" id="swing_2" value="" /><!-- value = "swing" -->
  <!-- 1 pool -->
  ...
  <input type="hidden" name="sofa_2" id="sofa_2" value="" /><!-- value = "sofa_1.png / sofa_2.png" -->
  <!-- 1 Large dinining table -->
  <input type="hidden" name="big_dining_1" id="big_dining_1" value="" /><!-- value = "Big dining table" -->
  ...
  <script>
    ...
    function handleDragStart(e) {
      ...
      if (current_user_role == 3) { // if current user is Architect 
        ...
        if(shapename != "Large Bed Room" && shapename != "Open kitchen and living room" && shapename != "Bathroom with shower" && shapename != "bath with bathtub"){
        ...
        if (shapename == "Open kitchen and living room") { // if shape name is Open kitchen and living room
        ...
        if (shapename == "Bathroom with shower") { // if shape name is  Bathroom with shower
          if ($('#bath_with_shower_1').val().length === 0) {
            $('#bath_with_shower_1').val(shapename);
            updatescore(postscore);
            // undo/redo start
            var new_input = `<input type='hidden' class='undo_redo_score' value='${postscore}' id='undo_'>`;
            $('#hidden_input_score_div').append(new_input); // undo/redo end
          }
          // else if ($('#bath_with_shower_2').val().length === 0) {
          //   $('#bath_with_shower_2').val(shapename);
          //   updatescore(postscore);
          //   var new_input = `<input type='hidden' class='undo_redo_score' value='${postscore}' id='undo_'>`;
          //   $('#hidden_input_score_div').append(new_input);
          // }
        ...
        if (shapename == "Bathroom with bathtub") { // if shape name is  bath with bathtub
      ...
      if (current_user_role == 2) {
        if(shapename != "Window" && shapename != "door" && shapename != "sliding doors"){
          var new_input = `<input type='hidden' class='undo_redo_score' value='0' id='undo_'>`;
        $('#hidden_input_score_div').append(new_input);
        }

        if (shapename == "Window") { //if shape is Window
      ...
      if (current_user_role == 1) {
        ...
        if (shapename == "swing") { // if shape name is swing
      ...
      if (current_user_role == 4) { // if user role is Interior Designer
        ...
        if(shapename != "double bed" && shapename != "night stand" && shapename != "single bed" && shapename != "sofa" && shapename != "Big dining table"){
          var new_input = `<input type='hidden' class='undo_redo_score' value='0' id='undo_'>`;
        $('#hidden_input_score_div').append(new_input);
        }
        ...
        if (shapename == "sofa") { // if shape name is sofa_1.png or sofa_2.png
        ...
        if (shapename == "Big dining table") { // if shape name is Big dining table

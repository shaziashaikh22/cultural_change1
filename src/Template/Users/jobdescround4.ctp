...
<body>
  <div class="container-fluid">
    <div class="row" style="background-color: white;border: 1px solid black;">
      ...
      <h1>Round 2- Phase 2- Execution</h1>
      </div>
    ...
    <div class="row">
      ...
      <div class="row" style="position: fixed;bottom:0;">
          ...
          <div class="btn btn-primary tooltip2">
                ...
                echo $this->Html->link(
                    'Next',
                    // ['controller' => 'Users', 'action' => 'video4'],['style'=>'color:white']
                    ['controller' => 'Users', 'action' => 'startgameround4'],['style'=>'color:white;font-weight:bold;font-size:20px;']
  ...
  <input type="hidden" value="In Progress" name="r2p1_status" id="r2p1_status"/>

  <!-- container fluid end -->
  <script>
    $(document).ready(function() {
      updatelogintablestatus(); // update loginmatchestable status for next phase i.e round 2 phase 2

     function updatelogintablestatus() {
      
      var r2p1_status = $('#r2p1_status').val();
       return $.ajax({
         url: "updateloginformatchesr2p1",
         type: "POST",
         data: {
           r2p1_status: r2p1_status,
         },

...
<body>
  <div class="container-fluid">
    <div class="row" style="background-color: white;border: 1px solid black;">
      ...
      <h1>Round 1- Phase 1- Planning</h1>
      ...
      <div class="col-md-6 offset-md-1" style="background-color:white;border: 1px solid #8080808c;">
        ...
        <div class="row">
          <div class="col-md-12" style="text-align:center;">
            <span style="font-size:25px;font-weight:bold;">JOB DESCRIPTION</span></div>
        </div>
...
<!-- Story -->
      ...
      <div class="row" style="position: fixed;bottom:0;">
          ...
          <div class="btn btn-primary tooltip2">
                ...
                echo $this->Html->link(
                    'Next',
                    ['controller' => 'Users', 'action' => 'instruction'],['style'=>'color:white;font-weight:bold;font-size:20px;']
                );
                ?>
            <div class="bottom">

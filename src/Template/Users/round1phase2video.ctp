        ...
        <div class="row">
            ...
            <div class="col-sm-10">
                ...
                <video width="80%" height="70%" controls id="myvideo">
                    <source type="video/mp4" src="<?php echo $this->request->webroot; ?>img/Round 1 Phase 2.mp4">
                </video>
                </div>
                ...
                echo $this->Html->link(
                    'Next',
                    ['controller' => 'Users', 'action' => 'startgameround1phase2'],['style'=>'color:white;font-weight:bold;font-size:20px;']
                );
                ?>
                <div class="bottom">
              <p style="color: white;">Click next to proceed with the whiteboard.</p>
            </div>
                </div></div>
            </div>
        </div>

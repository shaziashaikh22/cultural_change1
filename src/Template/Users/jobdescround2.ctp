  ...
  //  print_r($allJobDescriptions); 
   ?>
    <div class="row" style="background-color: white;border: 1px solid black;">
      ...
      <h1>Round 2- Phase 1- Planning</h1>
        <!-- <img src="<?php echo $this->request->webroot; ?>img/ROUND - 2.png" width="200px">
        <img src="<?php echo $this->request->webroot; ?>img/PHASE-1.png" width="200px"> -->
      </div>
      <!-- <div class="col-md-1" >
      </div> -->
    ...
    <div class="row">
      ...
      <button class="btn-primary" style="pointer-events:none;font-weight:bold;font-size: 30px;border-radius: 5px;"><?= $userType[0]['type_name']; ?>
    </button></div>
        </div><br>

        <div class="row">
          <div class="col-md-12" style="text-align:center;margin-left:4px;">
          <img src="<?php echo $this->request->webroot; ?>img/family01.png">
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-10 offset-md-1">
            <span style="font-size: 15px;font-weight: 500;">
              ...
              <?php foreach ($allJobDescriptions as $JobDescription) { ?>
      ...
      <div class="row" style="position: fixed;bottom:0;">
          ...
          <div class="btn btn-primary tooltip2">
                ...
                echo $this->Html->link(
                    'Next',
                    ['controller' => 'Users', 'action' => 'startgameround2'],['style'=>'color:white;font-weight:bold;font-size:20px;']
                );
                ?>
            <div class="bottom">
              <p style="color: white;">Click next to proceed to the whiteboard.</p>
            </div>
          </div>

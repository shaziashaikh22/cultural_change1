 ...
 * @var \App\Model\Entity\ShapeGroup[]|\Cake\Collection\CollectionInterface $shapeGroups
 */
?>
...
<section id="admin">
  ...
  <div class="sidebar" style="overflow-x: hidden;">
    ...
    <?php echo $this->Html->link(
    'Shape Groups',
            ['controller' => 'ShapeGroups', 'action' => 'index'],['class' => 'nav-link active']
    ...
    <table class="table table-hover">
        <thead>
            ...
            <th scope="col"><?= $this->Paginator->sort('id') ?></th>
                <th scope="col"><?= $this->Paginator->sort('shape_group_name') ?></th>
                <th scope="col"><?= $this->Paginator->sort('shape_group_description') ?></th>
        ...
        <tbody>
        <?php foreach ($shapeGroups as $shapeGroup): ?>
                <tr>
                ...
                <td class="actions">
                    <!-- <?= $this->Html->link(__('View'), ['action' => 'view', $shapeGroup->id]) ?> -->
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $shapeGroup->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $shapeGroup->id], ['confirm' => __('Are you sure you want to delete # {0}?', $shapeGroup->id)]) ?>
                </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
...
<div class="shapeGroups index large-9 medium-8 columns content">
    <h3><?= __('Shape Groups') ?></h3>

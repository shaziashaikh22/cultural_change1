        ...
        <div class="content">
            ...
            <div class="head">
                ...
                <div class="col-sm-12">
                    ...
                    <?php
                    echo "<p>" . $this->Form->control('shape_group_name', ['class' => 'form-control', 'style' => "width: 50%;"]) . "</p>";
                    echo "<p>" . $this->Form->control('shape_group_description', ['class' => 'form-control', 'style' => "width: 50%;"]) . "</p>";
...
<!-- <nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $shapeGroup->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $shapeGroup->id)]
            )
            ?></li>
...
<div class="shapeGroups form large-9 medium-8 columns content">
    <?= $this->Form->create($shapeGroup) ?>
    <fieldset>
        <legend><?= __('Edit Shape Group') ?></legend>
        <?php

...
<!--    <input id="filter" type="text" class="form-control" placeholder="Search Here ...">-->
    ...
    <?= $this->Form->create($question) ?>
                ...
                <?php
                echo "<p>" . $this->Form->control('question_type',['class' => 'form-control', 'style' => "width: 50%;"])."</p>" ;
                echo "<p>" .$this->Form->control('description',['class' => 'form-control', 'style' => "width: 50%;"])."</p>";
                echo "<p>" .$this->Form->control('answer',['class' => 'form-control', 'style' => "width: 50%;"])."</p>";

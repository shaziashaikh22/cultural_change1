...
<section id="admin">
  ...
  <div class="sidebar" style="overflow-x: hidden;">
    ...
    <?php echo $this->Html->link(
    'Access',
            ['controller' => 'Accesses', 'action' => 'index'],['class' => 'nav-link active']
    ...
    <table class="table table-hover">
        <thead>
            ...
            <th scope="col"><?= $this->Paginator->sort('id') ?></th>
                <th scope="col"><?= $this->Paginator->sort('access_name') ?></th>
                <th scope="col"><?= $this->Paginator->sort('access_description') ?></th>

        ...
        <div class="content">
            ...
            <div class="head">
                ...
                <div class="col-sm-12">
                    ...
                    <br />
                    <?php
                    echo "<p>" . $this->Form->control('access_name', ['class' => 'form-control', 'style' => "width: 50%;"]) . "</p>";
                    echo "<p>" . $this->Form->control('access_description', ['class' => 'form-control', 'style' => "width: 50%;"]) . "</p>";

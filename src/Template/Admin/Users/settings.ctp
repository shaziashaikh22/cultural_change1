        ...
        <div class="content">
            ...
            <div class="head">
                ...
                <div class="top">
                    <div class="left">
                        ...
                        <span style="font-weight: bold;font-size: 20px;">Settings</span>
                    </div>
                    <div class="right">
                        <div class="dropdown">
            ...
            <div class="col-sm-12">
                ...
                <div class="row" style="background:#E2E2E2;">
                    ...
                    <div class="col-md-3">
                        <img src="<?php echo $this->request->webroot; ?>img/duration.png" width="25px;" height="25px;">
                        <span style="color: #009B91;font-weight: bold;font-size: 20px;">DURATION</span>
                    </div>
                    <div class="col-md-2">
                        <div>
                            <select name="" id="" class="form-control" style="color:#009B91;font-weight: bold;box-shadow: 0px 6px 10px 0px rgb(0 0 0 / 36%);
                ...
                <div class="row" style="background:#E2E2E2;">
                    <div class="col-md-3"></div>
                    <div class="col-md-3">
                        <img src="<?php echo $this->request->webroot; ?>img/iterate.png" width="25px;" height="25px;">
                        <span style="color: #009B91;font-weight: bold;font-size: 20px;">ROUNDS</span>
                    </div>
                    <div class="col-md-2">
                        <div>
                            <select name="" id="" class="form-control" style="color:#009B91;font-weight: bold;box-shadow: 0px 6px 10px 0px rgb(0 0 0 / 36%);
                                  border-radius: 15px;border:none">
                                <option selected>2 ROUNDS</option>
                            </select>
                        </div>
                    </div>
                </div>

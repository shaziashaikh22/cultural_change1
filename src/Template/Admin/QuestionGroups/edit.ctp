    ...
    <section id="admin">
        ...
        <div class="content">
            ...
            <div class="col-sm-12">
                ...
                <?php
                echo "<p>" . $this->Form->control('question_group_name', ['class' => 'form-control', 'style' => "width: 50%;"]) . "</p>";
                echo "<p>" . $this->Form->control('question_group_description', ['class' => 'form-control', 'style' => "width: 50%;"]) . "</p>";
                echo "<p>" . $this->Form->control('question_status', ['class' => 'form-control', 'style' => "width: 50%;"]) . "</p>";
                ?>
                <br>
...
<!-- <nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $questionGroup->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $questionGroup->id)]
            )
            ?></li>

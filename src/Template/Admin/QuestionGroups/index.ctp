...
<section id="admin">
  ...
  <div class="sidebar" style="overflow-x: hidden;">
    ...
    <?php echo $this->Html->link(
    'Question Group',
            ['controller' => 'QuestionGroups', 'action' => 'index'],['class' => 'nav-link active']
...
<!--    <input id="filter" type="text" class="form-control" placeholder="Search Here ...">-->
    ...
    <table class="table table-hover">
        <thead>
            <tr>
               <th scope="col"><?= $this->Paginator->sort('id') ?></th>
                <th scope="col"><?= $this->Paginator->sort('question_group_name') ?></th>
                <th scope="col"><?= $this->Paginator->sort('question_group_description') ?></th>
                <th scope="col"><?= $this->Paginator->sort('question_status') ?></th>
        ...
        <?php foreach ($questionGroups as $questionGroup): ?>
                ...
                <td class="actions">
                    <!-- <?= $this->Html->link(__('View'), ['action' => 'view', $questionGroup->id]) ?> -->
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $questionGroup->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $questionGroup->id], ['confirm' => __('Are you sure you want to delete # {0}?', $questionGroup->id)]) ?>
                </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
